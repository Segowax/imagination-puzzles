...
#define SHOW_ELF_THREE ~(SEGMENT_A | SEGMENT_B | SEGMENT_C | SEGMENT_D | SEGMENT_E)
#define SHOW_ELF_FOUR ~(SEGMENT_A | SEGMENT_B | SEGMENT_C | SEGMENT_G)
#define SHOW_ELF_FIVE ~(SEGMENT_A | SEGMENT_B | SEGMENT_E | SEGMENT_F | SEGMENT_G)
#define SHOW_ELF_SIX ~(SEGMENT_A | SEGMENT_B | SEGMENT_D | SEGMENT_F | SEGMENT_G)
#define SHOW_ELF_SEVEN ~(SEGMENT_A | SEGMENT_B)
#define SHOW_ELF_EIGHT ~(SEGMENT_A | SEGMENT_B | SEGMENT_D)
#define SHOW_ELF_NINE ~(SEGMENT_A | SEGMENT_B | SEGMENT_D | SEGMENT_G)
